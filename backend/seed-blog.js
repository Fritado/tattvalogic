...
const seedBlogPost = async () => {
    try {
        ...
        // Clear existing blogs (optional, use with caution)
        ...
        const blogData = {
            ...
            content: `
                ...
                <blockquote class="border-primary bg-white/5 py-2 px-8 rounded-2xl">
            ...
            isPublished: true,
            featuredImage: "https://images.unsplash.com/photo-1558494949-ef010cbdcc51?q=80&w=2000&auto=format&fit=crop", // High quality tech image
