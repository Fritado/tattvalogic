...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const nextRoute = getDashboardRoute(data);
      ...
      >
        <div className="text-center mb-10">
          ...
          <div className="mt-2 inline-block px-3 py-1 bg-primary/10 border border-primary/20 rounded-full">
            <p className="text-[10px] font-black uppercase tracking-widest text-primary">Use your official company email to login</p>
          </div>
        </div>
